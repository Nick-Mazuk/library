...
describe('converts dates to Month DD, YYYY', () => {
    ...
    const dates: [number | string, string][] = [
        ...
        [1583020800000, 'February 29, 2020'],
        [1551398400000, 'February 28, 2019'],
        [1588291200000, 'April 30, 2020'],
...
describe('converts dates to Mon DD, YYYY', () => {
    ...
    const dates: [number | string, string][] = [
        ...
        [1583020800000, 'Feb 29, 2020'],
        [1551398400000, 'Feb 28, 2019'],
        [1588291200000, 'Apr 30, 2020'],
...
describe('converts dates to M/D/YYYY', () => {
    ...
    const dates: [number | string, string][] = [
        ...
        [1583020800000, '2/29/2020'],
        [1551398400000, '2/28/2019'],
        [1588291200000, '4/30/2020'],
